...
Public Class frmEntriKategoriAsset
    Public Property Model As Data.Entity.KategoriAsset
    Public Property PTipe As [Enum].PTipe

    Private ReadOnly Rep As Services.IKategoriAsset = New Repository.KategoriAsset()

    Public Sub New(PTipe As [Enum].PTipe, Model As Data.Entity.KategoriAsset)
    ...
    Private Sub frmEntriKategoriAsset_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If (PTipe = [Enum].PTipe.Create) Then
            Model = New Data.Entity.KategoriAsset With {
                .id = Guid.NewGuid,
                .kd_kategori = String.Empty,
        ...
        'Show Data
        KategoriAssetBindingSource.DataSource = Model
    ...
    Private Sub mnSimpan_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles mnSimpan.ItemClick
        ...
        If (Me.Validate) Then
            Dim Result As Tuple(Of Boolean, String, Data.Entity.KategoriAsset)
            ...
            Else
                Result = New Tuple(Of Boolean, String, Data.Entity.KategoriAsset)(False, "Tidak ada action", Nothing)
            End If
