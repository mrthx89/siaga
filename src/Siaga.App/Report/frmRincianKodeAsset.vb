...
Namespace Report
    Public Class frmRincianKodeAsset
                        ...
                        Try
                            ...
                            Dim sqlCheckSP As String = "SELECT COUNT(*) FROM information_schema.routines 
                                                    WHERE routine_schema = DATABASE() 
                                                      AND routine_name = 'spRincianKodeAsset' 
                                                      AND routine_type = 'PROCEDURE';"
                            com.CommandType = CommandType.Text
                            com.CommandText = sqlCheckSP
                            Dim count As Integer = Convert.ToInt32(com.ExecuteScalar())
                            If count = 0 Then
                                Dim sqlCreateSP As String = "CREATE PROCEDURE spRincianKodeAsset ( p_tanggal DATETIME ) 
                                                            BEGIN
                                                                SELECT
                                                                asset.id,
                                                                asset.kd_asset,
                                                                ...
                                                                WHERE pemutihan.id IS NULL
                                                                GROUP BY asset.id, asset.kd_asset, asset.nama_asset, asset.keterangan, kategoriasset.kd_kategori, kategoriasset.nama_kategori;
                                                            END"
        ...
        Private Sub frmRincianKodeAsset_Load(sender As Object, e As EventArgs) Handles MyBase.Load
