...
Namespace Report
    Public Class frmRincianAsset
                        ...
                        Try
                            ...
                            Dim sqlCheckSP As String = "SELECT COUNT(*) FROM information_schema.routines 
                                                    WHERE routine_schema = DATABASE() 
                                                      AND routine_name = 'spRincianAsset' 
                                                      AND routine_type = 'PROCEDURE';"
                            com.CommandType = CommandType.Text
                            com.CommandText = sqlCheckSP
                            Dim count As Integer = Convert.ToInt32(com.ExecuteScalar())
                            If count = 0 Then
                                Dim sqlCreateSP As String = "CREATE PROCEDURE spRincianAsset ( p_tanggal DATETIME ) 
                                                            BEGIN
                                                                SELECT
                                                                detailasset.id,
                                                                detailasset.barcode,
        ...
        Private Sub frmRincianAsset_Load(sender As Object, e As EventArgs) Handles MyBase.Load
