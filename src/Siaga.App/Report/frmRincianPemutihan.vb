...
Namespace Report
    Public Class frmRincianPemutihan
                        ...
                        Try
                            ...
                            Dim sqlCheckSP As String = "SELECT COUNT(*) FROM information_schema.routines 
                                                    WHERE routine_schema = DATABASE() 
                                                      AND routine_name = 'spRincianPemutihan' 
                                                      AND routine_type = 'PROCEDURE';"
                            com.CommandType = CommandType.Text
                            com.CommandText = sqlCheckSP
                            Dim count As Integer = Convert.ToInt32(com.ExecuteScalar())
                            If count = 0 Then
                                Dim sqlCreateSP As String = "CREATE PROCEDURE spRincianPemutihan ( p_tanggal DATETIME ) 
                                                            BEGIN
                                                                SELECT
                                                                detailasset.id,
                                                                detailasset.barcode,
                                                                ...
                                                                pemutihan.tgl_pemutihan,
                                                                pemutihan.keterangan keterangan_pemutihan
                                                                FROM
                                                                detailasset 
        ...
        Private Sub frmRincianPemutihan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
