...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AssetsRevisi
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AssetsRevisi))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202506200609370_AssetsRevisi"
            End Get
        End Property
