...
Namespace Migrations
    ...
    Public NotInheritable Partial Class PemakaianHistoryAssets
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(PemakaianHistoryAssets))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202506200334324_PemakaianHistoryAssets"
            End Get
        End Property
