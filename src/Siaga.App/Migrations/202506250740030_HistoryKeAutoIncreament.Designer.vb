...
Namespace Migrations
    ...
    Public NotInheritable Partial Class HistoryKeAutoIncreament
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(HistoryKeAutoIncreament))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202506250740030_HistoryKeAutoIncreament"
            End Get
        End Property
